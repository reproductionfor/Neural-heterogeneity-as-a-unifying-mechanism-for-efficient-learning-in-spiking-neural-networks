...
tr = 0;  %synaptic rise time 
td = 20; %decay time 
p = 0.1; %sparsity 
G =1.9*10^4; %Gain on the static matrix with 1/sqrt(N) scaling weights.  Note that the units of this have to be in pA. 
...
v = v+(vreset-v+theta*(v-vpeak)).*(v>=vpeak); %implements v = c if v>vpeak add 0 if false, add c-v if true, v+c-v = c
